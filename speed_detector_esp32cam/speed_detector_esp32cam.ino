...
// Use @myidbot to find out the chat ID of an individual or a group222222222222
...
// String chatId = "--984934329";
// String BOTtoken = "6169187364:AAEQDJpgOMdfeR4B7sM1LbX6glUL4AJeS6E";
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/SpeedOn@ESP32_Cam_motion23_bot") {
      ...
      String r_msg = "Speed detector is ON. /SpeedOff";
      lcd.setCursor(0, 0);
    ...
    if (text == "/SpeedOff@ESP32_Cam_motion23_bot") {
      ...
      String r_msg = "Speed detector is OFF. /SpeedOn";
      lcd.setCursor(0, 0);
      lcd.print("  MOTION SENSOR  ");
      lcd.setCursor(0, 1);
    ...
    if (text == "/start") {
      ...
      welcome += "/SpeedOn : Turn ON Motion Sensor\n";
      welcome += "/SpeedOff : Turn OFF Motion Sensor\n";
