...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/photo@Piezo_Motion_detector_bot") {
      sendPhoto = true;
    ...
    if (text == "/photoWithFlash@Piezo_Motion_detector_bot") {
      sendPhoto = true;
      withFlash = true;
      Serial.println("New photo request");
      lcd.setCursor(0, 0);
    ...
    if (text == "/lightOn@Piezo_Motion_detector_bot") {
      String r_msg = lightOn();
      bot.sendMessage(chatId, r_msg, "");
    }
    if (text == "/lightOff@Piezo_Motion_detector_bot") {
      String r_msg = lightOff();
      bot.sendMessage(chatId, r_msg, "");
    }
    if (text == "/motionOn@Piezo_Motion_detector_bot") {
    ...
    if (text == "/motionOff@Piezo_Motion_detector_bot") {
