...
const char* password = "Dammy4real";      //WiFi Password
...
// String BOTtoken = "6287318326:AAFXSaZ_RUA5SBSMx-q22WLgYFrNztg0U2w";

// String chatId = "-781508153";
// String BOTtoken = "6086948138:AAH1st4SDgYdvRZeHlduT5MRO4V0t3aZUec";

String chatId = "-4058040082";
String BOTtoken = "6824082990:AAGBt33t3iGeUYNTIHojVuHTHre-8NJPa8A";
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/photo@Pir_Mot_detect_bot") {
      sendPhoto = true;
    ...
    if (text == "/photoWithFlash@Pir_Mot_detect_bot") {
      sendPhoto = true;
      withFlash = true;
      Serial.println("New photo request");
      lcd.setCursor(0, 0);
    ...
    if (text == "/lightOn@Pir_Mot_detect_bot") {
    ...
    if (text == "/lightOff@Pir_Mot_detect_bot") {
    ...
    if (text == "/motionOn@Pir_Mot_detect_bot") {
    ...
    if (text == "/motionOff@Pir_Mot_detect_bot") {
    ...
    // if (text == "/weather@Pir_Mot_detect_bot") {
...
void loop() {
  ...
  if (digitalRead(PIR) == HIGH) {
    String r_msg = "Someone's at the door";
    bot.sendMessage(chatId, r_msg, "");
    lcd.clear();
    lcd.setCursor(0, 0);
